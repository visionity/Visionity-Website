        ...
        <div className="mt-6">
          ...
          <div className="flex flex-col sm:flex-row">
            <input 
              ...
              className={`px-4 py-2 rounded-lg ${darkMode ? "bg-gray-700 text-white border-gray-600 focus:border-blue-500" : "bg-white text-gray-800 border-gray-300 focus:border-blue-500"} border focus:outline-none focus:ring-1 focus:ring-blue-500 mb-2 sm:mb-0 sm:mr-2`}
            />
